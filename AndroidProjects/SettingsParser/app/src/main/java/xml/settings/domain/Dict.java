...
/**
 * Represents a Settings Dict object.
 * 
 * @author weichaojie
 */
public class Dict extends SettingsObject {
	...
	protected Map<java.lang.String, SettingsObject> configMap;

	public Dict() {
		configMap = new TreeMap<java.lang.String, SettingsObject>();
		setType(SettingsObjectType.DICT);
	}
	 ...
	 * @param value
	 */
	public void putConfig(java.lang.String key, SettingsObject value) {
	 ...
	 */
	public Map<java.lang.String, SettingsObject> getConfigMap() {
		return configMap;
	}
	 ...
	 */
	public void setConfigMap(Map<java.lang.String, SettingsObject> configMap) {
	...
	public <E extends SettingsObject> E getConfigurationObject(java.lang.String key) {
		StringTokenizer st = new StringTokenizer(key, DOT);

		if (st.hasMoreTokens()) {
			Map<java.lang.String, SettingsObject> dict = configMap;
			Object obj;
